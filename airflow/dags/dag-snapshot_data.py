...
# Lấy config
pipeline_config = DBT_PIPELINES['snapshots']

# Tạo DAG
dag = DAG(
    dag_id=pipeline_config['dag_id'],
    default_args=DEFAULT_ARGS,
    schedule=[Dataset('reports_completed')],  # Trigger by datasets
    catchup=False,
...
with dag:
    ...
    end = EmptyOperator(task_id='end', outlets=[Dataset('snapshots_completed')], trigger_rule= DEFAULT_CHECK_DAG['trigger_rule'])
